...
import { AppointmentDetailsModal, NewAppointmentModal } from './features/calendar/AppointmentModals'
...
function appointmentPresenceMeta(rawStatus: string, confirmationStatus?: AppointmentConfirmationStatus) {
